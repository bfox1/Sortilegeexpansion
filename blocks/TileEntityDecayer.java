...
import cpw.mods.fml.relauncher.SideOnly;
	...
	public class TileEntityDecayer extends TileEntity implements ISidedInventory{
		private static final int[] slots_top = new int[] {0};
		private static final int[] slots_bottom = new int[] {2, 1, 3, 4};
		...
		*/
    	...
    	public void updateEntity(){
        	...
        	if (!this.worldObj.isRemote){
            	...
            	{
                	flag1 = true;
                		BlockDecayer.updateFurnaceBlockState(this.power > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            		}	
        	}
