...
public class DecayerRecipes
{
    private static final DecayerRecipes smeltingBase = new DecayerRecipes();
     ...
     */
    public static final DecayerRecipes smelting()
    {
        return smeltingBase;
    }

    private DecayerRecipes()
    {
        this.addSmeltings(Block.oreIron.blockID, new ItemStack(Items.decayedironingot), new ItemStack(Items.lambentessence), 0.7F);
        this.addSmelting(Block.oreGold.blockID, new ItemStack(Items.decayedgoldingot), 1.0F);
        this.addSmelting(Block.oreDiamond.blockID, new ItemStack(Items.decayeddiamondshard), 1.0F);
        ...
        this.addSmelting(Block.oreCoal.blockID, new ItemStack(Items.decayedcoalchunk), 0.1F);
        this.addSmelting(Block.oreRedstone.blockID, new ItemStack(Item.redstone), 0.7F);
        this.addSmelting(Block.oreLapis.blockID, new ItemStack(Items.decayedlapischunk, 1, 4), 0.2F);
        this.addSmelting(Block.oreNetherQuartz.blockID, new ItemStack(Item.netherQuartz), 0.2F);
        

    }

    private void addSmeltings(int par1, ItemStack itemStack,
			ItemStack itemStack2, float f) {
